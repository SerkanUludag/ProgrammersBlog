...
namespace ProgrammersBlog.Web.Areas.Admin.Controllers
{
    ...
    public class OptionsController : Controller
    {
        ...
        public OptionsController(IOptionsSnapshot<AboutUsPageInfo> aboutUsPageInfo, IWritableOptions<AboutUsPageInfo> aboutUsPageInfoWriter, 
            ...
            IOptionsSnapshot<ArticleRightSideBarWidgetOptions> articleRightSideBarWidgetOptions, IWritableOptions<ArticleRightSideBarWidgetOptions> articleRightSideBarWidgetOptionsWriter,
            ICategoryService categoryService, IMapper mapper)
        {
            _aboutUsPageInfo = aboutUsPageInfo.Value;       // read AboutUsPageInfo section from appsetting.json
            _aboutUsPageInfoWriter = aboutUsPageInfoWriter;     // to write to appsetting.json
        ...
        public IActionResult About(AboutUsPageInfo aboutUsPageInfo)
        {
            if (ModelState.IsValid)
            {
                ...
                _toastNotification.AddSuccessToastMessage("About us page info updated.", new ToastrOptions
                {
        ...
        public IActionResult GeneralSettings(WebsiteInfo websiteInfo)
        {
            if (ModelState.IsValid)
            {
                ...
                _toastNotification.AddSuccessToastMessage("General settings updated.", new ToastrOptions
                {
                    Title = "Successfull operation!"
                });
        ...
        public IActionResult EmailSettings(SmtpSettings smtpSettings)
        {
            if (ModelState.IsValid)
            {
                ...
                _toastNotification.AddSuccessToastMessage("Email settings updated.", new ToastrOptions
                {
                    Title = "Successfull operation!"
                });
        ...
        public async Task<IActionResult> ArticleRightSideBarWidgetSettings(ArticleRightSideBarWidgetOptionsViewModel articleRightSideBarWidgetOptionsViewModel)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                _toastNotification.AddSuccessToastMessage("Article detail page widget settings updated.", new ToastrOptions
                {
                    Title = "Successfull operation!"
                });
                return View(articleRightSideBarWidgetOptionsViewModel);
